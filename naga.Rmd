...
I hypothesize that, as PPP GDP per capita increases (i.e., for richer entities), the log-odds of an entity mismanaging its daily plastic waste (compared to properly managing its daily plastic waste) is expected to decrease (while holding the entity's coastal population proportion constant). Additionally, I hypothesize that, as the relative size of an entity's coastal population (i.e., proportion of total population living within 50 kilometers of a coastline) increases, the log-odds of an entity mismanaging its daily plastic waste (compared to properly managing its daily plastic waste) is expected to increase (while holding the entity's PPP GDP per capita constant).
